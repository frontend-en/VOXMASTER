...
type Lesson = {
  ...
  price: string;
  durationHint: string;
  featured?: boolean;       // «Рекомендация»
  features: string[];
  footnote?: string;
  className?: string;       // доп. классы карточки (например, col-span)
};
...
export const PRICING_COPY = {
  kicker: "Тарифы",
  heading: "Три направления — одна цена",
  lead:
  ...
  lessons: [
    {
      title: "Урок вокала",
      price: "3000 ₽",
      durationHint: "≈40–50 мин • индивидуально • онлайн",
      featured: true,
      features: [
        ...
        "Техники для самостоятельной практики — безопасно и без перегруза",
        "Короткая «сверка» вопросов в начале следующего занятия",
      ],
      footnote: "Запись — по желанию ученика (на своей стороне).",
    },
    {
      title: "Урок сонграйтинга",
      price: "3000 ₽",
      durationHint: "≈40–50 мин • трек-ориентированно",
      features: [
        "Аранжировка: выбор инструментов, ритм-секция, интро/дроп/бридж, динамика",
        "Музыкальное мышление: рефлексы уха, контрасты, плотность, экономия идей",
        "Тексты: смысл → хук → слог; рифмы по смыслу, ритм фразы",
        "Сведение (база): громкости, панорама, EQ/компрессия «на пальцах»",
        "Структура и драматургия: где развивать, где экономить",
      ],
    },
    {
      title: "Урок прикладной теории",
      price: "3000 ₽",
      durationHint: "≈40–50 мин • ухо, ритм, гармония — на практике",
      className: "md:col-span-2 lg:col-span-1",
      features: [
        "Сольфеджио — уверенно попадать в ноты и подбирать мелодии на слух",
        "Ритм — развитие чувства ритма и применение в музыке и вокале",
        "Теория в действии — какие аккорды и ноты «работают» и почему",
        "Гармония и функции — строить понятные ходы без тыканья на удачу",
        "Подбор по слуху и разбор референсов — забирать принципы, а не копировать",
      ],
    },
  ],
  ...
  packsBlock: {
    heading: "Пакеты для спокойного прогресса",
    sub:
    ...
    packs: [
      {
        title: "4 занятия",
        price: "11 000 ₽",
        saveNote: "экономия 1 000 ₽",
        tagline: "Спокойный старт на месяц",
        benefits: [
      ...
      },
      {
        title: "8 занятий",
        price: "21 000 ₽",
        saveNote: "экономия 3 000 ₽",
        tagline: "Оптимально, если хотите регулярность 1–2 раза в неделю",
        benefits: [
    ...
    footnote:
      "Пакеты можно комбинировать: вокал/сонграйтинг/теория в любом соотношении. Срок действия — 60 дней.\nНе спешите: можно начать с одного урока — пакеты оформить позже.",
  },
};

export const SPECIAL_SERVICES_COPY = {
  kicker: "Специальные форматы",
  heading: "Особые случаи",
  lead:
    "Для тех, кому нужен максимальный разбор: супервизия методики для преподавателей и вокальный интенсив для учеников.",
  questionCta: "Задать вопрос",
  supervision: {
    title: "Супервизия для преподавателей",
    tagline: "Глубокая работа с методикой и сложными кейсами",
    price: "10 000 ₽",
    durationHint: "2–3 часа",
    description:
      "Формат для преподавателей, которые хотят повысить точность и эффективность своей работы. Разбор конкретных учеников, методических трудностей и неочевидных моментов в объяснении техники.",
    highlightsTitle: "В ходе супервизии:",
    highlights: [
      "Разбираю реальные случаи из вашей практики",
      'Анализирую причины вокальных "застреваний"',
      "Корректирую методику объяснения и подбора упражнений",
      "Структурирую процесс обучения и диагностику голоса",
      "Разбираю психологические и физиологические аспекты звучания",
    ],
    resultTitle: "Результат:",
    results: [
      "• Системное понимание процессов, происходящих с голосом ученика",
      "• Готовые решения для сложных кейсов",
      "• Более точная и уверенная педагогическая подача",
    ],
    ctaLabel: "Записаться на супервизию",
    planTitle: "Супервизия для преподавателей",
    planPrice: "10 000 ₽",
  },
  intensive: {
    title: "Вокальный интенсив",
    tagline: "Максимальный разбор за один созвон",
    price: "12 000 ₽",
    durationHint: "Разовый созвон, без ограничения по времени",
    description:
      "Формат для учеников, которым нужен глубокий анализ голоса и чёткий план развития. Без ограничения по времени — работаем до полного понимания картины.",
    highlightsTitle: "Во время интенсива:",
    highlights: [
      "Провожу полный анализ вашего голоса и вокальных привычек",
      "Определяем слабые зоны и их причины",
      "Подробно объясняю все необходимые техники вокала исходя из анализа ваших проблем",
      "Подбираю упражнения, которые дают реальный результат",
      "Формирую индивидуальную стратегию дальнейших упражнений",
      "Отвечаю на вопросы",
    ],
    resultTitle: "Результат:",
    results: [
      "• Полное понимание, как работает ваш голос",
      "• Конкретный план и инструменты для развития",
      '• Осознание принципов, а не просто "набор приёмов"',
    ],
    ctaLabel: "Записаться на интенсив",
    planTitle: "Вокальный интенсив",
    planPrice: "12 000 ₽",
  },
};
